        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
              Soy un desarrollador web full stack con más de 2 años de
              experiencia en la creación de aplicaciones web modernas y
              eficientes. Mi enfoque se centra en construir productos digitales
              que ofrezcan experiencias excepcionales y solucionen problemas
              reales.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
              Mi viaje en el desarrollo web comenzó por curiosidad y se
              convirtió en pasión. He trabajado con startups, agencias y
              empresas establecidas, lo que me ha permitido adquirir un conjunto
              diverso de habilidades y experiencias.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Cuando no estoy codificando, me gusta explorar nuevas tecnologías,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-blue-50 dark:bg-gray-800 p-6 rounded-lg shadow-md transition-transform hover:transform hover:scale-105 duration-300">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Especializado en crear interfaces de usuario atractivas,
            ...
            <div className="bg-blue-50 dark:bg-gray-800 p-6 rounded-lg shadow-md transition-transform hover:transform hover:scale-105 duration-300">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Construyo APIs robustas y eficientes que potencian aplicaciones
                escalables.
              </p>
            </div>
            ...
            <div className="sm:col-span-2 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-500 dark:to-indigo-500 p-6 rounded-lg shadow-md text-white">
              ...
              <p className="mb-0">
                "Creo que el mejor código no solo funciona, sino que es legible,
                mantenible y escalable. La tecnología debe resolver problemas
                reales y mejorar la vida de las personas."
              </p>
            </div>
          </div>
        </div>
